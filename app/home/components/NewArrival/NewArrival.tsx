...
const ProductCard: React.FC<ProductCardProps> = ({
  ...
  const cardClasses = isLarge ? "min-h-[400px]" : "min-h-[150px]";
  const imgHeight = isLarge ? 400 : 150;
  ...
  return (
    <div className={`${baseClasses} ${cardClasses} arrival-product-card`}>
      ...
      <div className="absolute bottom-4 left-4 text-white p-2 text-shadow-md">
        ...
        <a
          href="#"
          className="text-sm underline cursor-pointer hover:text-yellow-400"
        >
          Shop Now
        </a>
      </div>
  ...
  return (
    <section className="p-5 font-sans">
      <div className="mb-5">
        ...
        <h1 className="text-3xl font-semibold pb-6">New Arrival</h1>
      </div>
