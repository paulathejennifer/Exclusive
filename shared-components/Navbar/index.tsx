    ...
    <nav className="border-b">
      <div className="bg-black text-white text-xs py-2 text-center">
        <span>
          ...
          <span className="font-semibold underline cursor-pointer ml-2">Shop Now</span>
        </span>
      </div>
      <div className="flex flex-col md:flex-row items-center justify-between px-4 md:px-12 py-6 bg-white max-w-7xl mx-auto">
        ...
        <ul className="flex flex-wrap justify-center space-x-4 md:space-x-8 items-center font-medium mb-4 md:mb-0">
          <li>
            <Link
              href="/"
              className={`hover:text-[#A3005A] ${pathname === "/" ? "underline" : ""}`}
            >
              Home
            </Link>
          </li>
          <li>
            <Link
              href="/contact"
              className={`hover:text-[#A3005A] ${pathname === "/contact" ? "underline" : ""}`}
            >
              Contact
            </Link>
          </li>
          <li>
            <Link
              href="/about"
              className={`hover:text-[#A3005A] ${pathname === "/about" ? "underline" : ""}`}
            >
              About
            </Link>
          </li>
          <li>
            <Link
              href="/signup"
              className={`hover:text-[#A3005A] ${pathname === "/signup" ? "underline" : ""}`}
            >
              Sign Up
            </Link>
          </li>
