  ...
  return (
    <div className="max-w-[1200px] mx-auto px-4 sm:px-6 md:px-10">
      ...
      <div className="bg-black text-white text-xs sm:text-sm flex justify-center items-center gap-1.5 relative select-none py-2">
        ...
        <a href="#" className="font-bold underline whitespace-nowrap cursor-pointer">ShopNow</a>
        <select 
      ...
      <nav className="flex flex-wrap items-center gap-6 sm:gap-8 lg:gap-14 border-b border-gray-300 py-5 sm:py-6">
        ...
        <ul className="flex gap-4 sm:gap-8 flex-grow">
          <li><a href="#" className="text-black text-sm sm:text-base font-medium border-b-2 border-transparent pb-1 hover:border-black active:border-black font-semibold">Home</a></li>
          <li><a href="#" className="text-black text-sm sm:text-base font-medium border-b-2 border-transparent pb-1 hover:border-black">Contact</a></li>
          <li><a href="#" className="text-black text-sm sm:text-base font-medium border-b-2 border-transparent pb-1 hover:border-black">About</a></li>
          <li><a href="/signup" className="text-black text-sm sm:text-base font-medium border-b-2 border-transparent pb-1 hover:border-black">Sign Up</a></li>
        </ul>
        ...
        <div className="flex items-center gap-4 sm:gap-6 min-w-[200px] sm:min-w-[280px]">
          ...
          <button aria-label="Favorites" className="text-black text-lg cursor-pointer p-1.5">
            <FaHeart />
          </button>
          <button aria-label="Cart" className="text-black text-lg cursor-pointer p-1.5">
            <FaShoppingCart />
          </button>
        </div>
      </nav>
        ...
        <aside className="border-r border-gray-300 pr-4 lg:pr-6 min-w-full lg:min-w-[200px] select-none">
          <ul className="flex flex-row lg:flex-col gap-3 lg:gap-4 text-xs sm:text-base text-gray-900 overflow-x-auto lg:overflow-visible">
            {[
              ...
              >
                {label} {hasArrow && <FaGreaterThan className="text-gray-500 text-xs sm:text-sm" />}
              </li>
            ))}
          </ul>
        </aside>

        <section className="bg-black text-white rounded-md flex flex-col md:flex-row max-w-full md:max-w-[900px] p-8 md:p-[45px_60px] justify-between items-center gap-6 md:gap-10 select-none">
          <div className="max-w-full md:max-w-[380px] flex flex-col gap-4">
            ...
            <a href="#" className="text-[28px] sm:text-[32px] md:text-[35px] font-light underline cursor-pointer flex items-center gap-1.5 select-none w-max">
          ...
          <img 
            ...
            className="max-h-[180px] sm:max-h-[220px] md:max-h-[280px] object-contain select-none pointer-events-none mr-0 md:mr-[100px] relative w-full md:w-auto"
          />
        </section>
      </main>
    </div>
